...
public class HtmlReportSupport {
	...
	public static void createHtmlSummaryReport() throws Exception {
		...
		File file = new File(TestEngine.filePath() + File.separator + "SummaryResults_"
		...
		try {
			...
			writer.write("<title>DPC - Automation Execution Results Summary</title> on "+TestEngine.browser);
			...
			writer.write("DPC -  Automation Execution Result Summary on "+TestEngine.browser);
			writer.write("</th> ");
			writer.write("</tr> ");
			...
			while (iterator1.hasNext()) {
				Map.Entry mapEntry1 = iterator1.next();
	...
	@SuppressWarnings("rawtypes")
	public static void createHtmlSummaryReport(String browser, String Url) throws Exception {
		...
		try {
			...
			writer.write("<head> ");
			writer.write("<meta charset='UTF-8'> ");
			writer.write("<title>DPC - Automation Execution Results Summary on "+TestEngine.browser+ "</title>");
	...
	public static void onWarning(String strStepName, String strStepDes) {
		Writer writer = null;
		try {
			File file = new File(TestEngine.filePath() + "/" + strTestName+"_Results_"
					+ TestEngine.timeStamp + ".html");// "SummaryReport.html"
...
//			TestEngine.FailNum = TestEngine.FailNum + 1;
	...
	public static void testHeader(String testName, String browser) {
		Writer writer = null;
		try {
			strTestName = testName;
			File file = new File(TestEngine.filePath() +"/"+strTestName+ "_Results_"
	...
	public static void closeDetailedReport() {
		...
		File file = new File(TestEngine.filePath() + File.separator + strTestName+"_Results_"
				+ TestEngine.timeStamp + ".html");// "SummaryReport.html"
		Writer writer = null;
	...
	public static void copyLogos()
	{
    	...
    	File destFolder = new File(TestEngine.filePath()+File.separator+"Screenshots");
